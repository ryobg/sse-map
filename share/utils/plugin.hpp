...
std::filesystem::path const& plugin_directory ();
...
/// Sends off a binary message to specific or all SKSE plugins

bool dispatch_skse_message (void* data, std::size_t size, char const* target, int version = 1);
